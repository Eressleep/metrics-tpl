...
//   - ST1000 - проверка использования времени
//   - ST1001 - проверка использования time.Duration
//   - ST1003 - проверка именования
//   - ST1005 - проверка форматирования ошибок
//   - ST1006 - проверка использования string
//   - ST1008 - проверка использования констант
//   - ST1011 - проверка использования os.Exit
//   - ST1012 - проверка использования fmt.Sprintf
//   - ST1013 - проверка использования switch
//   - ST1015 - проверка использования if
//   - ST1016 - проверка использования range
//   - ST1017 - проверка использования default
//   - ST1018 - проверка использования var
//   - ST1019 - проверка использования type
//   - ST1020 - проверка документации
//   - ST1021 - проверка комментариев
//   - ST1022 - проверка использования receiver
//
// Публичные анализаторы:
//   - errcheck - проверяет, что ошибки обрабатываются
//   - ineffassign - проверяет неиспользуемые присваивания
//
...
func main() {
	...
	// Добавляем дополнительные анализаторы ST
	for _, a := range stylecheck.Analyzers {
		analyzers = append(analyzers, a)
	}

	// Добавляем публичные анализаторы (можно добавить другие)
	// errcheck и ineffassign нужно импортировать отдельно
