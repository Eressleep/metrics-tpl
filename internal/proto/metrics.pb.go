...
const file_metrics_proto_rawDesc = "" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x17.metrics.Metric.MTypeR\x04type\x12\x14\n" +
	"\x05delta\x18\x03 \x01(\x03R\x05delta\x12\x14\n" +
	"\x05value\x18\x04 \x01(\x01R\x05value\"=\n" +
	"\x05MType\x12\t\n" +
	"\x05GAUGE\x10\x00\x12\v\n" +
	"\aCOUNTER\x10\x01\x1a\x1c\n" +
	"\x12SkipTypeInJSON\x12\b\n" +
	"\x06\x62\x04id\x1a\x06H\x02\"@\n" +
	"\x14UpdateMetricsRequest\x12(\n" +
	"\ametrics\x18\x01 \x03(\v2\x0f.metrics.MetricR\ametrics\"\x17\n" +
	"\x15UpdateMetricsResponse2\\\n" +
	"\aMetrics\x12Q\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponse\"\x01\x00B&Z$github.com/Eressleep/metrics-tpl/internal/protob\x06proto3"
